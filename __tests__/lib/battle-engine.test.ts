  ...
  describe('simulateBattle', () => {
    it('should return a complete battle result', () => {
      const challenger = createMockFighter({ 
        profile: { id: 1, login: 'challenger', name: 'Challenger', avatar_url: 'https://example.com/c.png' },
        card: { attack: 80, defense: 60, speed: 70, archetype: 'Code Warrior', spirit_animal: 'Kangaroo' }
      });
      const opponent = createMockFighter({ 
        profile: { id: 2, login: 'opponent', name: 'Opponent', avatar_url: 'https://example.com/o.png' },
        card: { attack: 60, defense: 80, speed: 50, archetype: 'Bug Hunter', spirit_animal: 'Eagle' }
      });
    ...
    it('should have one fighter with 0 HP at the end', () => {
      const challenger = createMockFighter({ 
        ...
        card: { attack: 75, defense: 60, speed: 70, archetype: 'Code Warrior', spirit_animal: 'Kangaroo' }
      });
      const opponent = createMockFighter({ 
        profile: { id: 2, login: 'opponent', name: 'O', avatar_url: 'url' },
        card: { attack: 60, defense: 75, speed: 50, archetype: 'Bug Hunter', spirit_animal: 'Eagle' }
      });
    ...
    it('should generate battle log events', () => {
      ...
      const hasAttackEvents = result.battle_log.some(e => e.type === 'attack');
    ...
    it('should handle type advantages correctly', () => {
      const challenger = createMockFighter({ 
        profile: { id: 1, login: 'warrior', name: 'Warrior', avatar_url: 'url' },
        card: { attack: 70, defense: 60, speed: 70, archetype: 'Code Warrior', spirit_animal: 'Kangaroo' }
      });
      const opponent = createMockFighter({ 
        profile: { id: 2, login: 'hunter', name: 'Hunter', avatar_url: 'url' },
        card: { attack: 70, defense: 60, speed: 70, archetype: 'Bug Hunter', spirit_animal: 'Eagle' }
      });
