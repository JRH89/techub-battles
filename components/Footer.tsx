      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Battle system for TecHub profiles. Choose your fighter, engage in
              epic battles, and climb the leaderboard!
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-600 dark:text-slate-400 flex items-center gap-2">
            Made with{' '}
            <Heart className="h-4 w-4 text-red-500" fill="currentColor" /> for
